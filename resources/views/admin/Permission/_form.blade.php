...
{{--@if($cid == 0 )--}}
{{--图标修改--}}
    {{--<link rel="stylesheet" href="{{ asset("/plugin/bootstrap-iconpicker/icon-fonts/font-awesome-4.2.0/css/font-awesome.min.css")}}"/>--}}
    {{--<link rel="stylesheet" href="{{ asset("/plugin/bootstrap-iconpicker/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css") }}"/>--}}
    ...
    {{--@section('javascript')--}}
    {{--<script type="text/javascript" src="{{ asset("/plugin/bootstrap-iconpicker/bootstrap-iconpicker/js/iconset/iconset-fontawesome-4.3.0.min.js") }}"></script>--}}
    {{--<script type="text/javascript" src="{{ asset("/plugin/bootstrap-iconpicker/bootstrap-iconpicker/js/bootstrap-iconpicker.js") }}"></script>--}}
    {{--@stop--}}
{{--@endif--}}
