<!DOCTYPE html>
<html style='background-image: url({{asset("/images/login.jpg")}});'>
<head>
  <meta charset="utf-8">
...
<body class="hold-transition login-page" style="background: rgba(0,0,0,0)">
  ...
  <div class="login-box-body" style="width: 500px;margin: 0 auto; background: rgba(0,0,0,0);">
    ...
    <form action="{{ admin_base_path('login') }}" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <button type="submit" class="btn btn-primary btn-block btn-flat" style="width: 100%;background: #2E8EF2">{{ trans('admin.login') }}</button>
      </div>
    </form>
